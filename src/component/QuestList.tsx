...
export default function QuestList() {
  ...
  return (
    <div className="max-h-[75vh] max-sm:max-h-[75vh] overflow-auto p-5 flex flex-col justify-center items-center gap-7">
      <ToastContainer />
      ...
      <div className="flex justify-center items-center align-middle w-full mt-8">
        <div className="w-[90%] bg-gradient-to-r from-[#57676D] to-[#2A383C]  text-white rounded-[20px] flex items-center justify-between p-5">
