    ...
    <div className="Ranking max-w-full mx-auto text-white max-sm:h-[78vh] mt-8">
      ...
      <div className="flex flex-col justify-center items-center gap-4">
        ...
        <div
          ...
          className="flex flex-col justify-center items-center w-[80%] rounded-[10px] bg-gradient-to-r from-[#556165] to-[#293135] p-3"
        >
          <h2
        ...
        <div
          hidden={!colorTag ? false : true}
          className="flex justify-center items-center w-[80%] rounded-[10px] bg-gradient-to-r from-[#556165] to-[#293135] p-3 gap-2"
        >
          <h2
            className="text-[white] text-[xl]"
            style={{ fontFamily: "poppins" }}
